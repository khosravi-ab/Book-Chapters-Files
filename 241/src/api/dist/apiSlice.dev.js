...
exports.useDeleteBlogMutation = exports.useEditBlogMutation = exports.useAddNewBlogMutation = exports.useGetBlogQuery = exports.useGetBlogsQuery = exports.apiSlice = void 0;
  ...
  endpoints: function endpoints(builder) {
    return {
      ...
      deleteBlog: builder.mutation({
        query: function query(blogId) {
          return {
            url: "/blogs/".concat(blogId),
            method: "DELETE"
          };
        },
        invalidatesTags: ["BLOG"]
...
var useGetBlogsQuery = apiSlice.useGetBlogsQuery,
    ...
    useDeleteBlogMutation = apiSlice.useDeleteBlogMutation;
exports.useDeleteBlogMutation = useDeleteBlogMutation;
